...
- **온라인몰**: 고객 주문 결제 시 즉시 온라인몰 재고를 차감한 후, 각 매장 혹은 MFC로 상품을 적시 보충하기 위해 물류창고에서 출하지시가 일어납니다.
- **오프라인 매장**: 전국 1,300여 개 매장에서 POS 결제가 발생하면 즉시 매출로 인식하고, 이후 정산을 위한 거래 집계를 실시간으로 수행합니다.
